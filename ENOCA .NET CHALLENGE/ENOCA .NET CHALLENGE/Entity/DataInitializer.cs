...
namespace ENOCA.NET_CHALLENGE.Entity
{
    public class DataInitializer:DropCreateDatabaseIfModelChanges<DataContext>
    {
        protected override void Seed(DataContext context)
        {
            ...
            {
                new Product(){Name="a Fotoğraf makinesi",Description="a Fotoğraf makinesi",Price=1200, IsApproved=true,CategoryId=1,Stock=0,IsHome=true,Image="1.jpg"},
                ...
                new Product(){Name="a Bilgisayar",Description="a Bilgisayar",Price=1000, IsApproved=true,CategoryId=2,Stock=0,IsHome=true,Image="2.jpg"},
                new Product(){Name="b Bilgisayar",Description="b Bilgisayar",Price=1100, IsApproved=true,CategoryId=2,Stock=132,Image="2.jpg"},
                new Product(){Name="a Elektronik",Description="a Elektronik",Price=1300, IsApproved=true,CategoryId=3,Stock=0, Image = "3.jpg"},
                ...
                new Product(){Name="a Telefon",Description="a Telefon",Price=900, IsApproved=true,CategoryId=4,Stock=0, Image = "4.jpg"},
